...
-o, --obey-robots=<s>    Should we obey robots.txt? Default is true (default: True)
-e, --depth=<i>          Spidering depth - Think before setting too large a value (default: 2)
-s, --user-agent=<s>     Enter your own user agent string in double quotes! (default: Mozilla/5.0 (Windows NT 6.1; WOW64; rv:40.0)Gecko/20100101 Firefox/40.1)
-n, --dns-server=<s>     Provide a custom DNS server to use for subdomain lookups - Google resolver1 is the default (default:8.8.8.8)
